...
export default function MyDTR() {;
    ...
    return (
        <AuthenticatedLayoutEmployee>
            ...
            <div className="">
                <div>
                    <BodyContentLayoutPayslip headerName="PAYSLIP INFORMATION" headerFullname="FULL NAME: Jack Cole" headerContact="CONTACT NUMBER: 0912345678" headerDesignation="DESIGNATION: Agriculturist I" headerType="TYPE: Regular" className="h-screen mt-5 shadow-md" >
                        {/* <DataTable
                            columns={dtrcolumns}
                        ...
                        <div className="h-[70vh] overflow-x-hidden overflow-y-scroll scrollbar scrollbar-thumb-gray-400 scrollbar-track-gray-200">
                            <div className=' h-[270px] drop-shadow-custom  rounded px-5'>
                                ...
                                <div className='flex justify-start gap-56 mt-4'>
                                    <div>
                                        <span className="font-semibold">GSIS Premium:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">GSIS CONSO:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">GSIS MPL:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                ...
                                <div className='flex justify-start gap-56 mt-3'>
                                    <div>
                                        <span className="font-semibold">GSIS GFAL:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">GSIS PLR:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">GSIS Calamity:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                ...
                                <div className='flex justify-start gap-56 mt-4'>
                                    <div>
                                        <span className="font-semibold">HDMF Premium:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">HDMF MPL:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">HDMF CALAMITY:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                ...
                                <div className='flex justify-start gap-56 mt-3'>
                                    <div>
                                        <span className="font-semibold">HDMF M2:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">HDMF Housing:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">PHC Premium:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                ...
                                <div className='flex justify-start gap-56 mt-3'>
                                    <div>
                                        <span className="font-semibold">PCAEAE Dues:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">PCAEA Mortuary:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">PCAEA CDO:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                ...
                                <div className='flex justify-start gap-56 mt-3'>
                                    <div>
                                        <span className="font-semibold">PCAEAE EMPCO:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">PCAEA Loan:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
                                    <div>
                                        <span className="font-semibold">PCAEA Others:</span>
                                        <div className='pt-2'>
                                            <input type="text" placeholder='₱20,000.00' className='border-1 border-black rounded-sm w-80' />
                                        </div>
                                    </div>
